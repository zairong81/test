...
public class DownloadView2 extends AbstractView {
	...
	private static final Logger logger = LoggerFactory.getLogger(DownloadView2.class);
	...
	protected void renderMergedOutputModel(
		...
		//모델값 가져오기
		AttchfileDts file = (AttchfileDts) model.get("downFile2");
...
//		ServletContext context = request.getSession().getServletContext();
		...
		String filename = file.getSaveFileNm();
		...
		String outputName
		 = URLEncoder.encode( file.getOgnFileNm(), "utf-8" );
